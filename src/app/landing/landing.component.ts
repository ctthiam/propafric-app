...
export class LandingComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  plans = [
    {
      ...
      priceMonthly: '25 000',
      priceAnnual:  '20 000',
      period: 'FCFA / mois · jusqu\'à 20 biens',
    ...
    },
    {
      ...
      priceMonthly: '55 000',
      priceAnnual:  '44 000',
      period: 'FCFA / mois · jusqu\'à 100 biens',
  ...
  testimonials = [
    ...
    {
      quote: 'La gestion des TOM et de la TVA sur les frais de gestion était notre casse-tête. Avec PropAfric, tout est calculé automatiquement. Zéro erreur depuis 6 mois.',
      name: 'Seydou Fall',
      role: 'Fondateur — Zénith Immobilier, Dakar',
      initials: 'SF',
      featured: false,
    },
  ];
